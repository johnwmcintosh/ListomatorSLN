...
namespace Listomator.Core
{
    ...
    public class NavigationService : INavigationService
    {
        ...
        public void NavigateTo(string pageKey, object parameter1, object parameter2, object parameter3 = null, object parameter4 = null, object parameter5 = null, object parameter6 = null)
        {
            NavigateTo(pageKey, parameter1, parameter2, parameter3, parameter4, parameter5, parameter6, false);
        }

        private void NavigateTo(string pageKey, object parameter1, object parameter2, object parameter3, object parameter4, object parameter5, object parameter6, bool replaceRoot)
        {
            lock (_pagesByKey)
            {
