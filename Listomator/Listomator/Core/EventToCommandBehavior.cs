...
{
	/// <summary>
	/// Adapted from https://docs.microsoft.com/en-us/samples/xamarin/xamarin-forms-samples/behaviors-eventtocommandbehavior/
	/// </summary>
	public class EventToCommandBehavior : BehaviorBase<View>
    {
        ...
        public static readonly BindableProperty CommandProperty = BindableProperty.Create(nameof(Command), typeof(Command), typeof(EventToCommandBehavior), null);
